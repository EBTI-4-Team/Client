...
import Logo from '../assets/images/Logo.png'; // ✅ 로고 추가
    ...
    <div className="min-h-screen bg-[#FFF8EF]">
      ...
      <div className="flex pt-[80px]">
              ...
              <ul className="flex flex-col gap-4">
                ...
                <li>
                  <button
                    ...
                    className="w-full rounded-full bg-yellow-400 px-5 py-2.5 text-left text-sm font-medium text-white shadow-[0_2px_0_rgba(0,0,0,0.06)]"
                  >
                    마이페이지
                  </button>
                </li>
        ...
        <main className="ml-[288px] flex-1 px-8 py-10">
          <section className="w-full max-w-[920px] rounded-[16px] border-2 border-yellow-300 bg-white shadow-[0_6px_0_rgba(0,0,0,0.08)]">
            <div className="p-6 md:p-10">
              <div className="grid grid-cols-1 items-start gap-10 md:grid-cols-[200px_1fr]">
                {/* 아바타 */}
                <div className="flex items-start justify-center md:justify-start">
                  <div className="grid h-[250px] w-[230px] place-items-center overflow-hidden rounded-2xl bg-[#FFF8EF]">
                    <img
                      src={avatarSrc}
                      alt={ebti}
                ...
                <div className="w-full">
                  <dl className="grid grid-cols-1 gap-x-6 gap-y-8 md:grid-cols-[110px_1fr]">
                    <dt className="pt-2 text-center text-lg font-semibold text-neutral-600">
                      이름
                    </dt>
                    <dd className="pt-2 text-left text-base text-neutral-900">
                      {name}
                    </dd>
